...
Accessibility is allowing access to users no matter their physical capabilities or impairments.

2. Talk about 3 different things you can do to ensure your website is accessible. 

One way to make your site accessible is by making it keyboard friendly so that a keyboard can be used to navigate the page. 

Another way is to add alt text to all images on the site.

Also selecting colors that are contrast to each other to help those with color-blindness see your site better.


3. How would you explain the concept of a variable to someone new to programming?

A variable is a container or a box that is used to store a value. 


4. What is the purpose of using functions in code?

To use code over and over.
